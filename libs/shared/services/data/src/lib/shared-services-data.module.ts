...
export class SharedServicesDataModule {
  ...
  //Http GET
  public getAttendanceRequest(functionName: string, params: any): Observable<any> {
    return this.http
      .get('http://182.180.54.190:8000/' + functionName + params)
  ...
  // get Function
  public getAttendanceHttp(url: string, param: any): any {
    this.result = [];
    return this.getAttendanceRequest(url, param).pipe(takeUntil(this.destory$));
  }
  public deleteHttp(
    pageInterface: any,
